<body>
  <div class="container" id="atelier_container">
    <div class="col-md-3 col-sm-5 descontos" >
        ...
        <img src="<?php echo base_url('/site/img/blink_atelier.png') ?>" class="img-center" alt="" id="blink_atelier_logo">

        <dl class="dl-horizontal lista-vertical" style="color:#000;background:#F2A68B; padding:4%;margin-bottom: 0; width:100%;">

            <dd><span style="color:#fff;">&gt;</span> <a href="hair" class="no_link" onClick="ga('send', 'event', 'Home', 'Atelier', 'Hair');ga('send', 'event', 'Menu', 'Atelier', 'Hair');">CABELO</a></dd>
          </dl>

          <dl class="dl-horizontal lista-vertical" style="color:#000;background:#F28761; padding:4%;margin-bottom:0;width:100%;">
            <dd><span style="color:#fff;">&gt;</span><a href="makeup" class="no_link" onClick="ga('send', 'event', 'Home', 'Atelier', 'Makeup');ga('send', 'event', 'Menu', 'Atelier', 'Makeup');">MAQUIAGEM</a></dd>
          </dl>

          <dl class="dl-horizontal lista-vertical" style="color:#000;background:#F2A68B; padding:4%;width:100%;">
            <dd><span style="color:#fff;">&gt;</span> <a href="nails" class="no_link" onClick="ga('send', 'event', 'Home', 'Atelier', 'Nail');ga('send', 'event', 'Menu', 'Atelier', 'Nail');">UNHAS</a></dd>
          </dl>
      </div>

    <div class="col-md-9" style="padding:4% 0% 0% 4%;">
      <div class="col-md-4">
        <img src="<?php echo base_url('/site/img/atelier/makeup/make-circle.jpg') ?>" id="img_circle_atelier"
        class="img-circle img-center">
      </div>

      <div class="col-md-8" style="color:#888;">
        <h2 style="color:#000;" class="centralize-responsive">MAQUIAGEM</h2>
        <p>
Nessa sessão, a gente se preocupa em realçar a beleza do seu rosto. Por isso, quando a gente fala em make, a gente está indo muito além de um pozinho básico.
      ...
      <div class="col-md-12" style="color:#888;padding-top:4%;">
        <p>
          Também estamos falando de sobrancelha. De design e micropigmentação. Estamos falando de cílios, sejam eles permanentes ou não. A maquiagem pode, inclusive, ser completa ou express.
          E quer uma inspiração? A Blink.Me apresenta uma coletânea de penteados e maquiagens criados pela beauty artist Vanessa Rozan especialmente para você.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="container" id="portifolio_hair">
    <div class="col-md-12">
      <p class="centralize-responsive">Portifólio <span style="font-family:cursive">/</span>Maquiagem</p>
    </div>
  </div>
  ...
  <div class="" style="padding:0;">
    ...
    <div class="grid">
      ...
      <div class="grid-item grid-item--padrao">
          <img src="<?php echo base_url('/site/img/atelier/makeup/make1.jpg') ?>" class="mansory-img" alt="">
      </div>
      <div class="grid-item grid-item--height2 grid-item--padrao2">
        <img src="<?php echo base_url('/site/img/atelier/makeup/make2.jpg') ?>" alt="" class="mansory-img">
      </div>
      <div class="grid-item grid-item--padrao">
          <img src="<?php echo base_url('/site/img/atelier/makeup/make3.jpg') ?>" alt="" class="mansory-img">
      </div>
      <div class="grid-item grid-item--padrao">
        <img src="<?php echo base_url('/site/img/atelier/makeup/make4.png') ?>" style="height:190px;" alt="" class="mansory-img">
      </div>
      <div class="grid-item grid-item--height2 grid-item--padrao2">
      <p>5</p>
      </div>
        <div class="grid-item  grid-item--padrao2 grid-item--height2 ">
            <!-- <img src="<?php echo base_url('/site/img/atelier/makeup/make4.jpg') ?>" alt="" class="mansory-img"> -->
        </div>
        <div class="grid-item  grid-item--padrao">
  ...
  <div class="container-fluid" style="padding:40px 0px 40px 0px;background:#FDAF17;">
      <div class="col-md-12">
        <img src="<?php echo base_url('site/img/blink_pure.png') ?>" class="img_center img_cardapio" alt="">
      ...
      <div class="col-md-12" style="text-align:center;">
        ...
        onClick="ga('send', 'event', 'Home', 'Atelier', 'Instagram');ga('send', 'event', 'Menu', 'Atelier', 'Instagram');">
        ...
        onClick="ga('send', 'event', 'Home', 'Atelier', 'Facebook');ga('send', 'event', 'Menu', 'Atelier', 'Facebook');">
