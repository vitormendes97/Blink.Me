<body>
  <div class="container" id="atelier_container">
    ...
    <div class="col-md-9" style="padding:4% 0% 0% 4%;">
      <div class="col-md-4">
        <img src="<?php echo base_url('/site/img/atelier/nails/nail-circle.jpg') ?>" id="img_circle_atelier"
        class="img-circle img-center">
      </div>

      <div class="col-md-8" style="color:#888;">
        <h2 style="color:#000;" class="centralize-responsive">UNHAS</h2>
        <p>Você pode fazer um simples pé e mão ou ir além, com gel ou não. E aproveite para usar e abusar da nossa grande variedade de marcar e cores de esmalte.</p>
