...
<header>
                ...
                <ul class="nav navbar-nav ">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                          <li><a href="hair">CABELO</a></li>
                          <li><a href="nails">UNHAS</a></li>
                          <li><a href="makeup">MAQUIAGEM</a></li>
                      </ul>
                    </li>
    ...
    <div class="col-md-3 col-md-offset-9 menu-main-closed" id="submenu_geral">
        <div class="menu-desktop riad-bold">
            <ul>
                <li><a href="home" onClick="ga('send', 'event', 'Menu', 'Home', '');">HOME</a></li>
                <li><a style="cursor:pointer" onClick="ga('send', 'event', 'Home', 'Atelier', '');">ATELIER</a>
                    <ul class="sub-menu">
                        <li><a href="hair" onClick="ga('send', 'event', 'Menu', 'Atelier', 'Hair');">CABELO</a></li>
                        <li><a href="nails" onClick="ga('send', 'event', 'Menu', 'Atelier', 'Nail');">UNHAS</a></li>
                        <li><a href="makeup" onClick="ga('send', 'event', 'Menu', 'Atelier', 'Makeup');">MAQUIAGEM</a></li>
                    </ul>
                </li>
                <li><a href="cosmetics" onClick="ga('send', 'event', 'Menu', 'Cosmetics', '');
                ga('send', 'event', 'Home', 'Cosmetics', '');">COSMETICS</a></li>
                <li><a href="lab" onClick="ga('send', 'event', 'Menu', 'Lab', '');ga('send', 'event', 'Home', 'Lab', '');">LAB</a></li>
                <li><a href="club" onClick="ga('send', 'event', 'Menu', 'Club', '');">CLUB</a></li>
                <li><a href="contato" onClick="ga('send', 'event', 'Menu', 'Contato', '');">CONTATO</a></li>
            </ul>
        </div>
    </div>
</header>
