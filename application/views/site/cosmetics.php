      ...
      <div class="col-md-7">
          ...
          <div class="col-md-12">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <!-- Controls -->
              <a class="left carousel-control" style="background:none;" href="#carousel-example-generic" role="button" data-slide="prev" onClick="ga('send', 'event', 'Home', 'Cosmetics', 'Seta_esquerda');
              ga('send', 'event', 'Menu', 'Cosmetics', 'Seta_esquerda');">
                <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
              </a>
              <a class="right carousel-control" style="background:none;" href="#carousel-example-generic" role="button" data-slide="next" onClick="ga('send', 'event', 'Home', 'Cosmetics', 'Seta_direita');
              ga('send', 'event', 'Menu', 'Cosmetics', 'Seta_direita');" >
      ...
      <div class="col-md-5">
        ...
        <div class="col-md-12">
          <ul class="main-menu font-bold">
            <li>MAQUIAGEM
            <i class="glyphicon glyphicon-menu-down pull-right cursor-pointer closed"
            onClick="ga('send', 'event', 'Home', 'Cosmetics', 'Maquiagem');ga('send', 'event', 'Menu', 'Cosmetics', 'Maquiagem');"></i>
            ...
            <li>PERFUMES
              <i class="glyphicon glyphicon-menu-down pull-right cursor-pointer closed"
              onClick="ga('send', 'event', 'Home', 'Cosmetics', 'Perfumes');ga('send', 'event', 'Menu', 'Cosmetics', 'Perfumes');"></i>
              <ul class="cosmetics_menu">
                <li>A.Banderas</li>
                <li>Agatha Ruiz</li>
            ...
            <li>CORPO E BANHO
              <i class="glyphicon glyphicon-menu-down pull-right cursor-pointer closed"
              onClick="ga('send', 'event', 'Home', 'Cosmetics', 'Corpo-e-banho');ga('send', 'event', 'Menu', 'Cosmetics', 'Corpo-e-banho');"></i>
              <ul class="cosmetics_menu">
            ...
            <li>CABELOS
              <i class="glyphicon glyphicon-menu-down pull-right cursor-pointer closed"
              onClick="ga('send', 'event', 'Home', 'Cosmetics', 'Cabelos');ga('send', 'event', 'Menu', 'Cosmetics', 'Cabelos');"></i>
              <ul class="cosmetics_menu">
                <li>AcquaFlora</li>
                <li>AlfaParf</li>
                <li>Asian Secret</li>
            ...
            <li>HOMEM
              <i class="glyphicon glyphicon-menu-down pull-right cursor-pointer closed"
              onClick="ga('send', 'event', 'Home', 'Cosmetics', 'Homem');ga('send', 'event', 'Menu', 'Cosmetics', 'Homem')"></i>
              <ul class="cosmetics_menu">
                <li>AcquaFlora</li>
                <li>Dr.Jones</li>
            ...
            <li>NAILS
              <i class="glyphicon glyphicon-menu-down pull-right cursor-pointer closed"
              onClick="ga('send', 'event', 'Home', 'Cosmetics', 'Nails');ga('send', 'event', 'Menu', 'Cosmetics', 'Nails');"></i>
              <ul class="cosmetics_menu">
      ...
      <div class="col-md-12 text-center" >
          <div class="bg_control container">
            ...
            <div class="hidden-xs hidden-sm col-md-1 bg_text_cosmetic">
                <img src="<?php echo base_url('/site/img/cosmetics/barra.png') ?>" class="bar_cosmetics" alt="">
            </div>
