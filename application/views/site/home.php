<body>
    <section>
        ...
        <div class="container-fluid" style="padding-bottom:16px;background-color:#F38761;margin-top:30px;">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <h2 class="text-center tinta-text">BLINK.ME. UM MERGULHO NO MUNDO DA BELEZA</h2>
            </div>
            ...
            <div class="tinta col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="bgTintaHover" id="hoverCosmetics">
                    <img src="<?php echo base_url('site/img/blink_cosmetics.png')?>" /><br> Você encontrará aqui os produtos utilizados pelos profissionais para cabelos, as melhores maquiagens e perfumes, além de produtos para corpo e rosto. Difícil vai ser escolher entre as
                    mais de 60 marcas disponíveis. Mas o nosso time estará à disposição para tirar dúvidas, orientar e ajudar no momento de compra.</div>
            </div>
            ...
            <div class="tinta col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="bgTintaHover" id="hoverAtelier">
                    <img src="<?php echo base_url('site/img/blink_atelier.png') ?>" /><br> Está com vontade de mudar o visual, fazer um novo corte nos cabelos, mudar o penteado ou simplesmente trocar de esmalte? Esse é o espaço para um momento só seu, que torna você ainda mais
                    bonita. Selecionamos e treinamos os melhores profissionais e pensamos com muito carinho em tudo de que você precisa para ter uma experiência inesquecível. </div>
            </div>
            ...
            <div class="tinta col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="bgTintaHover" id="hoverLab">
                    <img src="<?php echo base_url('site/img/blink_lab.png') ?>" /><br> A blink.me foi criada para ser o seu momento. Mas, se você quiser, cabe mais gente. Foi pensando nisso que o Lab da blink.me foi criado para você se reunir com quem quiser. O nosso espaço
                    pode ser usado tanto para eventos pessoais quanto corporativos. O momento é seu e você escolhe o que fazer com ele. Para saber mais informações sobre a locação desse espaço, entre em contato conosco.</div>
            </div>
            ...
            <div class="tinta col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="bgTintaHover" id="hoverStudio">
                    <img src="<?php echo base_url('site/img/blink_studio.png') ?>" /><br> Depois de uma superprodução no nosso atelier, nada mais justo do que eternizar o momento com uma foto. Por isso, contamos com um cantinho exclusivo para tirar aquela foto profissional e
                    publicar nas redes sociais. Ou, se você for do tipo reservada, só guardar como recordação para se lembrar do quanto é maravilhosa. #blinkmemoment</div>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="container centralize-responsive" id="club" style="background:#F4F4F4;    padding: 20px 20px;">
            ...
            <div class="col-md-12 ">
               <a href="#">
                 <button type="button" class="btn btn-default" id="entrar-btn">Entrar</button>
               </a>
            </div>
        </div>
